...
| 678 | **Cambie reconstruction complete, machine-checked in Lean, and integrated into `main` through PR #17**; D4 and E1–E4 passed; canonical unbounded witnesses and infinitely many good block lengths proved; post-merge CI is the final archival gate | `678/LEAN_FORMALIZATION_ROADMAP.md` |
