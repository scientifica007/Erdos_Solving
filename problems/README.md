...
| 678 | active Cambie reconstruction in Lean; Claim 5 and Claim 4/D4 are machine-checked through the sharp Cambie representative endpoint under explicit large-`k` and sharp-prime-window data; Phase E1 LCM-ratio estimate is next; sharp-prime existence remains the separate E2 dependency | `678/LEAN_FORMALIZATION_ROADMAP.md` |
