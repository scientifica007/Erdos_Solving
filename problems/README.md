...
| 678 | active Cambie reconstruction in Lean; Claim 5 and the scaled Claim 4 connection to both residue interfaces are checked; quantitative scale/representative construction is current; CI green | `678/LEAN_FORMALIZATION_ROADMAP.md` |
