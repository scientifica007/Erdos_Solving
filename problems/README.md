...
| 678 | active Cambie reconstruction in Lean; Claim 5 is checked; constructed scales, prime-window/search bounds, factorization, and a dependent close-and-separated Claim 4 endpoint feeding full Claim 5 are checked; the sharp Cambie room inequalities are current; CI green | `678/LEAN_FORMALIZATION_ROADMAP.md` |
